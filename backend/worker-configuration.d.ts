/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f89b4b2cd444cd60edf6ded4678a2085)
// Runtime types generated with workerd@1.20260111.0 2026-01-25 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		JWT_SECRET: "edRaSjloqNrOSt7m53yvywlakoyll7oRb/1ngJRdXec=";
		DATABASE_URL: string;
	}
}
